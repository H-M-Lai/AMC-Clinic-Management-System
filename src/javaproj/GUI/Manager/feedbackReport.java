...
import java.awt.*;
import java.io.File;
import javaproj.Methods.Report.FeedbackReportService;
...
public class feedbackReport extends javax.swing.JPanel {
    ...
    public feedbackReport(PanelController controller) {
        ...
        addToolbarButton("Rating Distribution", () -> {
            showChart(feedbackReportService.createRatingChart());
            updateDescription("This chart shows the distribution of feedback ratings from customers. It provides a quick overview of overall satisfaction levels.");
        });
        

        addToolbarButton("Average Rating by Doctor", () -> {
            showChart(feedbackReportService.createDoctorChart());
            updateDescription("This chart shows the average feedback rating received by each doctor. It helps compare performance and patient satisfaction across doctors.");
        });
    ...
    private void updateDescription(String desc) {
        ...
        addSummaryItem("Total Feedbacks", String.valueOf(feedbackReportService.totalFeedbacks()), null, true);
        addSummaryItem("Average Rating", String.format("%.2f", feedbackReportService.avgRating()), new Color(0,102,204), true);
        addSummaryItem("Highest Rating", String.valueOf(feedbackReportService.highest()), new Color(0,153,76), false);
        addSummaryItem("Lowest Rating", String.valueOf(feedbackReportService.lowest()), new Color(204,0,0), false);
    ...
    private void printReport() {
        try {
            String path = feedbackReportService.generateReportFile(); 
